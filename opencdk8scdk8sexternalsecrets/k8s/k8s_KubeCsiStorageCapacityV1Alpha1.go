...
// The jsii proxy struct for KubeCsiStorageCapacityV1Alpha1
type jsiiProxy_KubeCsiStorageCapacityV1Alpha1 struct {
	internal.Type__cdk8sApiObject
}

func (j *jsiiProxy_KubeCsiStorageCapacityV1Alpha1) ApiGroup() *string {
	var returns *string
	_jsii_.Get(
		j,
		"apiGroup",
...
func (j *jsiiProxy_KubeCsiStorageCapacityV1Alpha1) ApiVersion() *string {
	var returns *string
	_jsii_.Get(
		j,
		"apiVersion",
...
func (j *jsiiProxy_KubeCsiStorageCapacityV1Alpha1) Chart() cdk8s.Chart {
...
func (j *jsiiProxy_KubeCsiStorageCapacityV1Alpha1) Kind() *string {
	var returns *string
	_jsii_.Get(
		j,
		"kind",
...
func (j *jsiiProxy_KubeCsiStorageCapacityV1Alpha1) Metadata() cdk8s.ApiObjectMetadataDefinition {
...
func (j *jsiiProxy_KubeCsiStorageCapacityV1Alpha1) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_KubeCsiStorageCapacityV1Alpha1) Node() constructs.Node {
...
func NewKubeCsiStorageCapacityV1Alpha1(scope constructs.Construct, id *string, props *KubeCsiStorageCapacityV1Alpha1Props) KubeCsiStorageCapacityV1Alpha1 {
	...
	if err := validateNewKubeCsiStorageCapacityV1Alpha1Parameters(scope, id, props); err != nil {
		panic(err)
	}
...
func KubeCsiStorageCapacityV1Alpha1_IsConstruct(x interface{}) *bool {
	...
	if err := validateKubeCsiStorageCapacityV1Alpha1_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func KubeCsiStorageCapacityV1Alpha1_Manifest(props *KubeCsiStorageCapacityV1Alpha1Props) interface{} {
	...
	if err := validateKubeCsiStorageCapacityV1Alpha1_ManifestParameters(props); err != nil {
		panic(err)
	}
...
func KubeCsiStorageCapacityV1Alpha1_Of(c constructs.IConstruct) cdk8s.ApiObject {
	...
	if err := validateKubeCsiStorageCapacityV1Alpha1_OfParameters(c); err != nil {
		panic(err)
	}
...
func (k *jsiiProxy_KubeCsiStorageCapacityV1Alpha1) AddDependency(dependencies ...constructs.IConstruct) {
	args := []interface{}{}
...
func (k *jsiiProxy_KubeCsiStorageCapacityV1Alpha1) ToJson() interface{} {
	var returns interface{}
...
func (k *jsiiProxy_KubeCsiStorageCapacityV1Alpha1) ToString() *string {
	var returns *string
